...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="/GV/capnhatdkpm">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="/GV/dsachphongmuon">
            <i class="fas fa-fw fa-table"></i>
            <span>Duyệt cho SV mượn máy <sup>2</sup></span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/GV/lichsudk">
